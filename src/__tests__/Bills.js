...
describe("Given I am connected as an employee", () => {
  describe("When I am on Bills Page", () => {
    ...
    /**
     * Dans ce premier test on souhaite verifier la présence d'une classe sur un élemément HTML
     * 
     * - Definie la Route
     * - Mock les données
  ...
  describe("When I click on the button 'Nouvelle note de frais'", () => {
    ...
    **/
      ...
      expect(getByText(document.body, "Envoyer une note de frais")).toBeTruthy();
  ...
  describe("When I click on the eye icon", () => {
    test("A modal should open", () => {
      ...
      const handleClickIconEye = jest.fn(bills.handleClickIconEye(firstEyeIcon));
