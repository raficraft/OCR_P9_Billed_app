...
export const filteredBills = (data, status) => {
  // console.log("filtered Bills : ", data, status);
...
export default class {
  ...
  handleEditTicket(e, bill, bills) {
    ...
    if (this.counter % 2 === 0) {
      ...
      //Review OCR [Bug-Hunt] - Dashboard
      // remove line
      // redifine counter with this.counter++
    } else {
  ...
  handleShowTickets(e, bills, index) {
    // console.log("deploie le listing");
